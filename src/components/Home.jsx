          ...
          <Col lg={12} xs={12}>
            ...
            <h2 className="lead" align="center">
              ...
              <span
                class="txt-rotate"
                data-period="2000"
                data-rotate='[ " am a Full-Stack Developer.", " can work with ML.", " love software engineering.", " am working on Problem Solving.", " am a learner for life!" ]'
              ></span>
            </h2>
          </Col>
        </Row>

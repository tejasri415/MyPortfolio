            ...
            <Col lg={2} xs={4}>
              ...
              <Card className="nbcard">
                ...
                {/* <Button variant={darkMode ? "outline-light" : "outline-dark"} className="skills-btn">
                    <FontAwesomeIcon className="skill" size='2x' icon={faCode}/>
                    </Button> */}
                <Button
                  variant={darkMode ? "outline-light" : "outline-dark"}
                  className="skills-btn"
            ...
            <Col lg={6} xs={12}>
              ...
              <Card className="skill-nbcard">
                <Card.Body>
                  ...
                  <Card.Text>
                    HTML, CSS, Bootstrap, ReactJs, Material UI, Node.js
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="skill-nbcard">
                <Card.Body>
                  ...
                  <Card.Text>VS Code, Github, Figma, MySQL,MOngoDB</Card.Text>
                </Card.Body>
              </Card>
            </Col>
          </Row>
